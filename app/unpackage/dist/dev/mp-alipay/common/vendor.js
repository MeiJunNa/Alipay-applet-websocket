...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"app","VUE_APP_PLATFORM":"mp-alipay","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 4 */
/*!**********************************************************!*\
  !*** C:/Users/Administrator/Desktop/自备WS/app/pages.json ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 11 */
/*!********************************************************!*\
  !*** C:/Users/Administrator/Desktop/自备WS/app/store.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  state: {
    socketTask: null,
    eventlist: [],
    wssHost: "ws://你的IP地址:998/message?name=",
    interval: null },

  mutations: {
    WEBSOCKET_INIT: function WEBSOCKET_INIT(state, accessToken) {
      if (state.socketTask != null) {
        return;
      }
      console.log('==========wssHost+accessToken=========', state.wssHost + accessToken);
      ...
      my.connectSocket({
        url: state.wssHost + accessToken, // 开发者服务器接口地址，必须是 wss 协议，且域名必须是后台配置的合法域名
        data: {},
        header: {
          'content-type': 'application/json' },

        success: function success(res) {
          console.log("websocket连接成功", res == "欢迎使用！" ? res : JSON.stringify(
          res)); // 返回 "{}",一个空的字典对象。
        },
        fail: function fail() {
      ...
      my.onSocketOpen(function (res) {
        ...
        my.onSocketMessage(function (res) {
          console.log("收到服务器内容：" + res == "欢迎使用！" ? res : JSON.stringify(res));
    ...
    WEBSOCKET_SEND: function WEBSOCKET_SEND(state, p) {
      ...
      my.sendSocketMessage({
        ...
        success: function success() {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                    console.log("消息发送成功");case 1:case "end":return _context2.stop();}}}, _callee2);}))();
        } });


    },
    WEBSOCKET_CLOSE: function WEBSOCKET_CLOSE(state, accessToken) {
      console.log("关闭推送");
  ...
  actions: {
    ...
    accessToken) {var commit = _ref.commit;
    ...
    WEBSOCKET_CLOSE: function WEBSOCKET_CLOSE(_ref3,

    p) {var commit = _ref3.commit;
